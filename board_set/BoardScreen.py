...
def BoardScreen(background): # 보드판 배경 그리기
    ...
    text_1 = font.render("조선", True, (0, 0, 0))  # 조선 색깔
    text_2 = font.render("유람", True, (0, 0, 0))  # 유람 색깔

    background.blit(text_1, (695, 440))  # 조선 글자 위치 조정
    background.blit(text_2, (695, 505))  # 유람 글자 위치 조정
