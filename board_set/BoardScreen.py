...
def BoardScreen(background): # 보드판 배경 그리기
    ...
    img_han = pygame.image.load("C:/Users/aa010/OneDrive/Desktop/TeamMarble/board_set/한반도.png") # 한반도 사진 불러오기
    img_han = pygame.transform.scale(img_han,(200,400)) # 사진 크기 조정
    background.blit(img_han,(650,300)) # 사진 위치 조정

    # 게임 판에 중앙 글씨 넣기(조선 유람)
    font = pygame.font.Font("C:/Users/aa010/OneDrive/Desktop/TeamMarble/board_set/font.ttf", 60)  # 폰트, 크기 조정
